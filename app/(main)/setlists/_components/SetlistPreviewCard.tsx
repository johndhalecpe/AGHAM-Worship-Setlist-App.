              ...
              <div className="shrink-0 flex items-center gap-1.5">
                {spotifyUrl ? (
                  <>
                    <button
                      onClick={async (e) => {
                        ...
                        if (!t) return;
                        try {
                          const res = await fetch(`/api/setlists/${setlist.id}/spotify-playlist/verify`, {
                          ...
                          if (exists) {
                            ...
                            setSpotifyUrl(null);
                            toast.success("Playlist was deleted on Spotify. Create a new one.");
                          }
                        } catch {
                          window.open(spotifyUrl, "_blank");
                        }
                      ...
                      className="rounded-lg px-2.5 py-1.5 text-xs font-semibold transition-all hover:-translate-y-0.5 active:scale-95 flex items-center gap-1.5"
                      style={{ border: "1.5px solid #1DB954", color: "#1DB954" }}
                    >
                  ...
                  >
                    ...
                    {isCreatingPlaylist ? "" : "Create Playlist"}
                  </button>
                )}
              </div>
            </div>
